"""
Evaluate trained model_templates on the official CUB test set
"""
import os
import sys
import torch
...
def eval(args):
    ...
    wrong_idx: image ids where the model got the wrong class prediction (to compare with other model_templates)
    """
    if args.model_dir:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-model_dirs', default=None, nargs='+', help='where the trained model_templates are saved')
