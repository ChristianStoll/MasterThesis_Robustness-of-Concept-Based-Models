...
def inception_v3(pretrained, freeze, **kwargs):
    ...
    .. note::
        **Important**: In contrast to the other model_templates the inception_v3 expects tensors with a size of
...
class Inception3(nn.Module):
    # similar to https://github.com/pytorch/vision/blob/master/torchvision/models/inception.py
