...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 bbox_reg_weights=None, enable_grad=False): # TODO enable_grad added
        ...
        transform = GeneralizedRCNNTransform(min_size, max_size, image_mean, image_std, enable_grad) # TODO enable grad added
